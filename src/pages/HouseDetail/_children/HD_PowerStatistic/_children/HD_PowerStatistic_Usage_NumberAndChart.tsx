...
import HD_PowerStatistic_PieChart from "./HD_PowerStatistic_PieChart";

interface HD_PowerStatistic_Usage_NumberAndChartProps {
  title: string;
}

export default function HD_PowerStatistic_Usage_NumberAndChart({
  title,
}: HD_PowerStatistic_Usage_NumberAndChartProps) {
  return (
