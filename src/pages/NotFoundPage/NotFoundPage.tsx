...
export default function NotFoundPage() {
  return (
    <main className="flex h-screen w-full flex-col items-center justify-center bg-lightBg dark:bg-darkBg">
      <h1 className="text-9xl font-extrabold tracking-widest text-darkText dark:text-lightText">
        404
      </h1>
      <div className="absolute rotate-12 rounded bg-haretaColor px-2 text-sm">
        Page not found
      </div>
