...
export default function MainFooter() {
  return (
    <div className="flex flex-row border-t border-black w-full bg-white md:flex-row justify-between items-stretch gap-4 py-[2rem]">
      <div className="basis-1/2 flex flex-col items-center justify-center text-center h-full">
        <img
          ...
          alt="Logo"
        />
        {/* <p className="text-gray-text text-[1.5rem]">
      ...
      <div className="basis-1/2 flex flex-col items-start justify-center text-left h-full gap-[3rem] pl-[10rem]">
        <p className="text-gray-text font-bold mb-2 text-[1.8rem] pt-5">
          Thông tin liên hệ và hỗ trợ
        </p>
        <div className="flex items-center text-gray-text text-[1.5rem] gap-2">
